...
/**
**Limitation:**  
The existing tests in `authorSchema.test.ts` focus only on schema validation rules and virtual properties. 
They don't verify interactions with the real database, meaning issues like database constraints,
connection errors, or integration problems might not be detected by these tests.
 */
